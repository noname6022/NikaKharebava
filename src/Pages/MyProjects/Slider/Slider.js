...
import Ala from "./ImagesCollection/Ala.webp";
import AlaMobile from "./ImagesCollection/AlaMobile.webp";
      ...
      <div className="SliderWrapper">
        <Slider {...settings}>
          ...
          <div className="Slides">
            ...
            <a
              href="https://vineyarddao.netlify.app/"
              className="SlideLink"
              target="_blank">
              Vineyard DAO
            </a>
          ...
          <div className="Slides">
            ...
            <a
              href="https://app.dubbledex.com/"
              className="SlideLink SlideLinklong"
              target="_blank">
              Dubble Exchange dashboard
            </a>
          </div>

          <div className="Slides">
            <MediaQuery maxWidth={480}>
              <a href="https://a-lmd.com/" target="_blank">
                <img src={AlaMobile} className="SlideImages" />
              </a>
            </MediaQuery>
            <MediaQuery minWidth={481}>
              <a href="https://a-lmd.com/" target="_blank">
                <img src={Ala} className="SlideImages" />
              </a>
            </MediaQuery>
            <a
              href="https://a-lmd.com/"
              className="SlideLink SlideLinklong"
              target="_blank">
