...
export const Contacts = () => {
  ...
  return (
    ...
    <div class="marquee">
  <div class="track">
    <div class="content">&nbsp;contacts contacts contacts contacts 
                          ...
                          <div class="arrow-wrapper talkArrowWrapper">
                            ...
                            <div class="arrow-wrapper talkArrowWrapper talkArrowWrapperSecond">
                              ...
                              <div class="arrow talkArrow"></div>
                                ...
                                <a className="telegramLink" href="https://t.me/yopblip" target="_blank"><img className="telegramIcon" src={TgIcon}/></a>
                                <a className="discordLink"  href = "mailto: ayanami10009@gmail.com"><img className="discordIcon" src={MailIcon}/></a>
