...
export const Contacts = () => {
  ...
  return (
    <section className='ContactsWrapper panel'>
                          ...
                          <div class="arrow-wrapper talkArrowWrapper">
                            ...
                            <div class="arrow-wrapper talkArrowWrapper talkArrowWrapperSecond">
                              ...
                              <div class="arrow talkArrow"></div>
                                ...
                                <a className="telegramLink" href="#"><img className="telegramIcon" src={TgIcon}/></a>
                                <a className="discordLink"  href="#"><img className="discordIcon" src={DiscordIcon}/></a>
